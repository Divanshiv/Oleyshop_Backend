...
Route::group(['as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'employee_active_check']], function () {
        ...
        Route::get('sub-category/status/{id}/{status}', [CategoryController::class, 'subCategoryStatus'])->name('sub-category.status');
        Route::post('sub-category/switch-parent', [CategoryController::class, 'switchParent'])->name('sub-category.switch-parent');
        Route::delete('sub-category/delete/{id}', [CategoryController::class, 'deleteSubCategory'])->name('sub-category.delete');
        Route::get('category/children/{parent}', [CategoryController::class, 'getSubCategories'])->name('category.children');
