...
AnalyticController extends Controller
{
    ...
    public function getKeywordSearch(Request $request): View|Factory|Application
    {
        ...
        if ($request->has('date_range')) {
            ...
            $queryParams['date_range'] = 'all_time';
        }
        ...
        return view('admin-views.analytics.keyword-search', compact('queryParams', 'graphData', 'search', 'categoryWiseVolumes', 'total', 'searchedKeywordCount', 'searchedTableData', 'perPage'));
    }
    ...
    public function getCustomerSearch(Request $request): View|Factory|Application
    {
        ...
        return view('admin-views.analytics.customer-search', compact('customersData', 'queryParams', 'topCustomer', 'topProducts', 'graphData', 'search', 'total', 'perPage'));
    }
