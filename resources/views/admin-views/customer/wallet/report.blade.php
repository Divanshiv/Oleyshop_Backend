    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title text-capitalize">
                <div class="card-header-icon d-inline-flex mr-2 img">
                    <img src="{{ asset('/public/assets/admin/img/wallet.png') }}" alt="{{ translate('wallet') }}"
                        class="width-24">
                </div>
                <span>
                            ...
                            <div class="mb-3">
                                <select id='customer' name="customer_id"
                                    ...
                                    @if (request()->get('customer_id') && ($customerInfo = \App\User::find(request()->get('customer_id'))))
                                        <option value="{{ $customerInfo->id }}" selected>
                                            {{ $customerInfo->f_name . ' ' . $customerInfo->l_name }}({{ $customerInfo->phone }})
                                        </option>
                                    @endif
                                </select>
                            </div>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body p-0">
                        ...
                        <tbody>
                            @foreach ($transactions as $k => $walletTransaction)
                                <tr scope="row">
                                    ...
                                    <td>
                                        <a
                                            href="{{ route('admin.customer.view', ['user_id' => $walletTransaction->user_id]) }}">
                                    ...
                                    <td>{{ date('Y/m/d ' . config('timeformat'), strtotime($walletTransaction->created_at)) }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="">
                    {!! $transactions->links('layouts/admin/partials/_pagination', ['perPage' => $perPage]) !!}
                </div>
