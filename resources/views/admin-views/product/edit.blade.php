                    ...
                    <div class="card-body pt-2">
                        ...
                        @else
                            <div id="{{ $default_lang }}-form">
                                <div class="form-group">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <label class="input-label mb-0" for="exampleFormControlInput1">{{ translate('name') }}(EN)</label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" step="1"
                                                    value="{{ $product['point_value'] ?? 500 }}" name="point_value" id="point_value"
                                                    class="form-control" placeholder="{{ translate('Ex : 500') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
