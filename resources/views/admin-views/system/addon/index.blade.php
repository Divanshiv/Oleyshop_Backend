                ...
                <form enctype="multipart/form-data" id="theme_form">
                    <div class="row g-3">
                        <div class="col-sm-6 col-lg-5 col-xl-4 col-xxl-3">
                            <div class="uploadDnD">
                                <div class="form-group border-dashed-cus rounded p-2 inputDnD mb-3">
                                    <input type="file" name="file_upload" class="form-control-file text-wrap text-break text--primary font-weight-bold input-file"
                                ...
                                <div class="d-flex flex-wrap align-items-center gap-3">
                                    ...
                                    <div class="flex-grow-1 text-start">
                                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                                            <span id="name_of_file" class="text-truncate fs-12"></span>
                                            <span class="text-muted fs-12" id="progress-label">0%</span>
                                        </div>
