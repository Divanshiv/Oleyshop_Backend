        ...
        <form action="{{route('admin.business-settings.web-app.third-party.update-fcm-messages')}}" method="post"
            ...
            <div class="card">
                <div class=" card-header-shadow pb-0">
                    <div class="d-flex align-items-center px-3 flex-wrap justify-content-between w-100 gap-2">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="push-notify">
                            ...
                            <div class="lang_form" id="default-form">
                                ...
                                <div class="bg-card-xxl mb-20">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="bg-white rounded p-xxl-20 mb-20">
                                                <div class="mb-lg-4 mb-3">
                                                    <h4 class="mb-1 fs-16">{{translate('Order Status Notifications')}}</h4>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                for="pending_status">
                                                            ...
                                                            <span class="d-block text-dark">{{translate('order')}} {{translate('pending')}} {{translate('message')}}</span>
                                                        </span>
                                                            </label>
                                                            <textarea rows="3" name="pending_message" class="form-control">{{$data['message']}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                <span class="d-block text-dark"> {{translate('order')}} {{translate('confirmation')}} {{translate('message')}}</span>
                                                            </span>
                                                            </label>

                                                            <textarea rows="3" name="confirm_message" class="form-control">{{$data['message']}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                    <span
                                                                        class="d-block text-dark">{{translate('order_processing_message')}}</span>
                                                                </span>
                                                            </label>

                                                            <textarea rows="3" name="dm_order_processing_message" class="form-control">{{$data['message']??''}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                <span class="d-block text-dark">{{translate('order')}} {{translate('out_for_delivery')}} {{translate('message')}}</span>
                                                            </span>
                                                            </label>
                                                            <textarea rows="3" name="out_for_delivery_message" class="form-control">{{$data['message']}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                <span class="d-block text-dark">{{translate('order')}} {{translate('delivered')}} {{translate('message')}}</span>
                                                            </span>
                                                            </label>

                                                            <textarea rows="3" name="delivered_message" class="form-control">{{$data['message']}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                    <span
                                                                        class="d-block text-dark">{{translate('Order_returned_message')}}</span>
                                                                </span>
                                                            </label>
                                                            <textarea rows="3" name="returned_message" class="form-control">{{$data['message']??''}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                    <span
                                                                        class="d-block text-dark">{{translate('Order_failed_message')}}</span>
                                                                </span>
                                                            </label>

                                                            <textarea rows="3" name="failed_message" class="form-control">{{$data['message']??''}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                    <span
                                                                        class="d-block text-dark">{{translate('Order_canceled_message')}}</span>
                                                                </span>
                                                            </label>

                                                            <textarea rows="3" name="canceled_message" class="form-control">{{$data['message']??''}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                <span class="d-block text-dark">{{translate('deliveryman')}} {{translate('assign')}} {{translate('message')}}</span>
                                                            </span>
                                                            </label>

                                                            <textarea rows="3" name="delivery_boy_assign_message" class="form-control">{{$data['message']}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                <span class="d-block text-dark"> {{translate('deliveryman')}} {{translate('start')}} {{translate('message')}}</span>
                                                            </span>
                                                            </label>

                                                            <textarea rows="3" name="delivery_boy_start_message" class="form-control">{{$data['message']}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                <span class="d-block text-dark">{{translate('deliveryman')}} {{translate('delivered')}} {{translate('message')}}</span>
                                                            </span>
                                                            </label>

                                                            <textarea rows="3" name="delivery_boy_delivered_message" class="form-control">{{$data['message']}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                <span class="d-block text-dark">{{translate('order')}} {{translate('Packaging')}} {{translate('message')}}</span>
                                                                </span>
                                                            </label>

                                                            <textarea rows="3" name="processing_message" class="form-control">{{$data['message']}}</textarea>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="bg-white rounded p-xxl-20 mb-20">
                                                <div class="mb-lg-4 mb-3">
                                                    <h4 class="mb-0 fs-16">{{translate('Deliveryman Notification')}}</h4>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                <span
                                                                    class="d-block text-dark">{{translate('Deliveryman assign notification for customer')}}</span>
                                                            </span>
                                                            </label>

                                                            <textarea rows="3" name="customer_notify_message" class="form-control">{{$data['message']??''}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="bg-white rounded p-xxl-20 mb-20">
                                                <div class="mb-lg-4 mb-3">
                                                    <h4 class="mb-0 fs-16">{{translate('Wallet Notification')}}</h4>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                    <span
                                                                        class="d-block text-dark">{{translate('add_fund_wallet_message')}}</span>
                                                                </span>
                                                            </label>

                                                            <textarea rows="3" name="add_fund_message" class="form-control">{{$data['message']??''}}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label class="align-items-center d-flex flex-row-reverse mb-10px toggle-switch"
                                                                ...
                                                                <span class="toggle-switch-content">
                                                                    <span
                                                                        class="d-block text-dark">{{translate('add_fund_wallet_bonus_message')}}</span>
                                                                </span>
                                                            </label>

                                                            <textarea rows="3" name="add_fund_bonus_message" class="form-control">{{$data['message']??''}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            @foreach($notification_message_array as $key => $item)
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea rows="3" name="{{$item['field_name']}}_message[]" class="form-control" placeholder="{{translate('Ex : Your order have been place')}}">{!! !empty($temporary) ? $temporary[$lang_code]['message'] : '' !!}</textarea>
                                                    </div>
                                                </div>
                                            @endforeach
...
{{--                    <div class="bg-card-static">--}}
{{--                        <div class="mb-20">--}}
{{--                            <h4 class="mb-1 fs-16">{{translate('Behavior-Based Notification Messages  (Customer)')}}</h4>--}}
{{--                            <p class="mb-0 fs-12">{{translate('Configure messages sent automatically when customer behaviour matches predefined conditions.')}}</p>--}}
{{--                        </div>--}}
{{--                        <div class="bg-white rounded p-xxl-20 p-2">--}}
{{--                            <div class="mb-lg-4 mb-3 d-flex align-items-center gap-2 flex-sm-nowrap flex-wrap justify-content-between">--}}
{{--                                <div>--}}
{{--                                    <h4 class="mb-1 fs-16">{{translate('Cart Abandon Reminder')}}</h4>--}}
{{--                                    <p class="mb-0 fs-12">{{translate('Configure the messages of automatic reminder for customers when items remain in their cart after a set time')}}</p>--}}
{{--                                </div>--}}
{{--                                <label class="toggle-switch" for="reminder">--}}
{{--                                    <input type="checkbox" name="" class="toggle-switch-input" value="" id="reminder" checked="">--}}
{{--                                    <span class="toggle-switch-label">--}}
{{--                                        <span class="toggle-switch-indicator"></span>--}}
{{--                                    </span>--}}
{{--                                </label>--}}
...
{{--                                <div class="col-md-6 col-12">--}}
{{--                                    <div class="form-group">--}}
{{--                                        <label class="mb-10px d-flex align-items-center gap-1" for="">--}}
{{--                                            <span class="d-block text-dark">{{translate('Cart Abandon Reminder Message')}}</span>--}}
{{--                                        </label>--}}
{{--                                        <textarea name="" rows="1" class="form-control min-h-45px" placeholder="Order Processing Message"></textarea>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="col-md-6 col-12">--}}
{{--                                    <div class="form-group">--}}
{{--                                        <label class="mb-10px d-flex align-items-center gap-1" for="">--}}
{{--                                            <span class="d-block text-dark">{{translate('Send reminder after')}}</span>--}}
{{--                                        </label>--}}
{{--                                        <div class="border rounded d-flex align-items-center">--}}
{{--                                            <input name="" class="form-control border-0 outline-0" placeholder="Ex: 3"></input>--}}
{{--                                            <div class="">--}}
{{--                                                <select name="" class="bg-card-common form-control border-0 outline-0 w-auto">--}}
