...
--
-- Host: localhost:8889
-- Generation Time: Nov 05, 2025 at 11:06 AM
...
(6, 'mail_config', '{\"status\":0,\"name\":\"Delivery APP\",\"host\":\"mail.demo.com\",\"driver\":\"smtp\",\"port\":\"587\",\"username\":\"info@demo.com\",\"email_id\":\"info@demo.com\",\"encryption\":\"tls\",\"password\":\"demo\"}', NULL, '2025-05-18 16:22:52'),
...
(19, 'terms_and_conditions', '{\"background_image\":null,\"description\":\"<p><\\/p>\"}', NULL, '2021-05-30 08:51:56'),
...
(40, 'privacy_policy', '{\"background_image\":null,\"description\":\"<p>rjdrjf<\\/p>\"}', NULL, '2021-05-30 08:52:40'),
(41, 'about_us', '{\"background_image\":null,\"description\":\"<p><strong>hello<\\/strong><\\/p>\"}', NULL, '2021-05-30 08:44:52'),
...
(62, 'faq', '{\"background_image\":null,\"description\":\"\"}', NULL, NULL),
...
(168, '2025_04_23_125626_add_bring_change_amount_in_orders_table', 63),
(169, '2025_04_27_110451_create_order_change_amounts_table', 63),
(170, '2025_04_30_141936_add_denied_note_in_offline_payments_table', 63),
(171, '2025_09_03_172258_create_ai_settings_table', 64),
(172, '2025_11_03_115604_update_bussiness_pages_data_to_business_settings_table', 64),
(173, '2025_11_03_215351_update_decimal_data_type_to_orders_table', 64),
(174, '2025_11_03_215701_update_decimal_data_type_to_order_details_table', 64);
...
CREATE TABLE `orders` (
  ...
  `user_id` bigint DEFAULT NULL,
  `is_guest` tinyint NOT NULL DEFAULT '0',
  `order_amount` decimal(24,18) NOT NULL,
  `coupon_discount_amount` decimal(24,18) NOT NULL,
  ...
  `total_tax_amount` decimal(24,18) NOT NULL,
  ...
  `delivery_charge` decimal(24,18) NOT NULL,
  ...
  `extra_discount` decimal(24,18) NOT NULL,
  ...
  `payment_note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `free_delivery_amount` decimal(24,18) NOT NULL,
  `weight_charge_amount` decimal(24,18) NOT NULL,
  `bring_change_amount` decimal(24,18) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `order_details` (
  ...
  `tax_amount` decimal(24,18) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
